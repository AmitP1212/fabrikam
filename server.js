...
var onDefault=function(req, res){
    res.send("<h1>Dear Mummy and Maushi</h1>"+
              ...
              "<ul>"+
					 ...
					 "<br/>Your words are my guidance, and your love is the most precious item to me."+
					 "<br/>Now, this is the opportunity to thank you for everything U did for me.</li>"+
                     "<li>To the woman that always brought the best in me "+
					 "<br/>or at least saw the best in me regardless of what I did.</li>"+
                     "<li>My amazing mother and Maushi,"+
					 "<br/>Your birthday deserves all the amazing colorsof celebration."+
					 "<br/>You both are the best mother's in all the land.</li>"+
                     "<br/>Happy Birthday Dear Lovely Ladies"+
             "</ul>");
};
